            ...
            <div className='flex flex-col content-evenly'>
                <div className='grid grid-cols-2 justify-center my-2 w-full'>
                    <div className='mr-3'>
                        ...
                        <input type="text" name="firstName" id="firstName" placeholder='First Name' className='border-2 border-blue-200 rounded-lg p-1 w-full hover:ring'
                        value={firstName} onChange={(e) => setFirstName(e.target.value)} /> 
                    </div>
                    <div>
                        <label htmlFor="lastName" className='block'>Last Name</label>
                        <input type="text" name="lastName" id="lastName" placeholder='Last Name' className='border-2 border-blue-200 rounded-lg p-1 w-full hover:ring'
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" placeholder='Email' value={email} className='border-2 border-blue-200 rounded-lg p-1 w-full hover:ring'
